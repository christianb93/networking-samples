...
sudo ip link set veth4 netns boxB
...
sudo ip netns exec boxB ip addr add 172.16.200.5/24 dev veth4
sudo ip netns exec router ip addr add 172.16.200.1/24 dev veth3
...
sudo ip netns exec boxB ip link set dev veth4 up
